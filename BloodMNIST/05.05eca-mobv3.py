...
from models import eca_mobilenetv3
...
if __name__ == "__main__":
    ...
    # 定义模型
    model_ft = eca_mobilenetv3.eca_mobilenet_v2(num_classes=CLASSES)
    print(model_ft)
    ...
    accdf.to_csv('05ecamobilev3-acc.csv')
    lossdf = pd.DataFrame(lossnp)
    lossdf.to_csv('05ecamobilev3-loss.csv')
    # 训练结束
    time_elapsed = time.time() - since
    print()
    print('任务完成！')
