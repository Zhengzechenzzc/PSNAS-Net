...
from models import MobileNetv3_demo
...
if __name__ == "__main__":
    ...
    # 定义模型
    model_ft = torchvision.models.mobilenet_v3_large(pretrained=False, num_classes=CLASSES)
    print(model_ft)
    ...
    accdf.to_csv('01mobv3l-acc.csv')
    lossdf = pd.DataFrame(lossnp)
    lossdf.to_csv('01mobv3l-loss.csv')
    # 训练结束
    time_elapsed = time.time() - since
    print()
    print('任务完成！')
