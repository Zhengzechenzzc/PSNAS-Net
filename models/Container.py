...
def container_any(params, pretrained=False, **kwargs):
    model = VisionTransformer(
        img_size=[224, 56, 28, 14], patch_size=[4, 2, 2, 2],
        embed_dim=[params['embed_1'], params['embed_1']*2, params['embed_3'], params['embed_1']*4],
        depth=[params['depth_1'], params['depth_2'], params['depth_3'], params['depth_4']],
