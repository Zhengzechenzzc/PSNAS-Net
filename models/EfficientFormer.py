...
class EfficientFormer(nn.Module):
    ...
    def __init__(self, params, layers, embed_dims=None,
...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 10, 'input_size': (3, 112, 112), 'pool_size': None,
...
def efficientformer_any(params, **kwargs):
    model = EfficientFormer(params,
        layers=[params['layer_1'], params['layer_2'], params['layer_3'], params['layer_4']],
        embed_dims=[params['embeddim_1'], params['embeddim_1']*2, params['embeddim_3'], params['embeddim_4']],
