...
class ECA_MobileNetV2(nn.Module):
    def __init__(self, params, num_classes=1000, width_mult=1.0):
        ...
        inverted_residual_setting = [
            ...
            # [6, 160, 3, 2],
            # [6, 320, 1, 1],
            [1, params['ch_1'], params['blocks_1'], 1],
            [6, params['ch_2'], params['blocks_2'], 2],
            [6, params['ch_3'], params['blocks_3'], 2],
            [6, params['ch_4'], params['blocks_4'], 2],
            [6, params['ch_5'], params['blocks_5'], 1],
            [6, params['ch_6'], params['blocks_6'], 2],
            [6, params['ch_7'], params['blocks_7'], 1],
        ]
