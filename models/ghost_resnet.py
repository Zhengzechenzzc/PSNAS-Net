...
class ResNet(nn.Module):
    ...
    # def __init__(self, params, block, layers, num_classes=1000, s=4, d=3):
    def __init__(self, params, block=Bottleneck, num_classes=1000, s=4, d=3):
        self.inplanes = 64
        ...
        self.relu = nn.ReLU(inplace=True)
        # TODO make_layer中的 通道数、layer中4个参数
        ...
        self.maxpool = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        self.layer1 = self._make_layer(block, params['ch_1'], params['layer_1'], stride=1, s=params['s_1'], d=d)
        self.layer2 = self._make_layer(block, params['ch_2'], params['layer_2'], stride=2, s=params['s_2'], d=d)
        self.layer3 = self._make_layer(block, params['ch_3'], params['layer_3'], stride=2, s=params['s_3'], d=d)
        self.layer4 = self._make_layer(block, params['ch_4'], params['layer_4'], stride=2, s=params['s_4'], d=d)
    ...
    def _make_layer(self, block, planes, blocks, stride=1, s=4, d=3):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            ...
            # in_channels, out_channels, kernel_size, dw_size=3, ratio=2, stride=1,
            #                  padding=0, dilation=1, groups=1, bias=True
