...
def groupmixformer_any(params, pretrained=False, **kwargs):
    model_kwargs = dict(
        num_stages=params['num_stages'],
        num_classes=10,
        embedding_dims=[params['embedding_dims'], params['embedding_dims']*2,
                        params['embedding_dims']*4, params['embedding_dims']*4],
        serial_depths=[params['serial_depths'], params['serial_depths']*2,
                       params['serial_depths']*6, params['serial_depths']*2],
    ...
    model = GroupMixFormer(pretrained=pretrained, **model_kwargs)
    return model
