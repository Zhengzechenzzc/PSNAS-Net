...
def mobilevit_any(params, num_classes):
    dims = [params['dims_1'], params['dims_2'], params['dims_3']]
    channels = [params['ch_1'], params['ch_2'], params['ch_3'],
                params['ch_3'], params['ch_5'], params['ch_6'],
                params['ch_7'], params['ch_7']*4]
    return MobileViT(112, dims, channels, num_classes=num_classes)
