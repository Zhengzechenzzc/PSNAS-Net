...
def cmt_any(params, pretrained=False, **kwargs):
    model_kwargs = dict(
        qkv_bias=True, embed_dims=[params['embed_dim'],params['embed_dim']*2,params['embed_dim']*4,
                                   params['embed_dim']*8],
        stem_channel=params['stem_ch'], num_heads=[1,2,4,8],
        depths=[3,3,params['depth_3'],3], mlp_ratios=[params['mlp_ratios'],params['mlp_ratios'],
                                                      params['mlp_ratios'],params['mlp_ratios']],
        qk_ratio=1, sr_ratios=[8,4,2,1], dp=params['dp'], **kwargs)
